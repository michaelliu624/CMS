...
<div class="row" id="pages">
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12">
                <!-- BEGIN PAGE TITLE & BREADCRUMB-->
                <h3 class="page-title" id="index-page-title">成绩查询</h3>
        ...
        <table id="travel" >
            <thead>
            <tr>
                <th scope="col" rowspan="2">课程编码</th>
                <th scope="col" colspan="6">成绩统计</th>
            </tr>
