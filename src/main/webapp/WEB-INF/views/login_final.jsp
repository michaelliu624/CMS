...
<!-- BEGIN LOGO -->
<div class="logo">
	<img src="<%=path%>/assets/img/logo-big.png" alt=""/>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
	...
	<form class="login-form" action="<%=path%>/rest/login" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input name="username" id="username" size="25" value="michaelliu@sohu-inc.com" class="form-control placeholder-no-fix" type="text" autocomplete="on" placeholder="用户名" />
			</div>
		</div>
		<div class="form-group">
